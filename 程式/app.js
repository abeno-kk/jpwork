...
function normalizeState(input) {
  ...
  return {
    ...
    triggerMonitorSync: normalizeChannelSummarySync(input.triggerMonitorSync || input.channelSummarySync),
...
function renderNavigation() {
  ...
  const activeGroup = state.view === 'tasks' || state.view === 'task-archive'
    ? 'tasks'
    : ['channels', 'channel-history', 'channel-summary', 'update-list', 'trigger-monitor', 'poison-monitor', 'google-play-monitor'].includes(state.view)
      ? 'channels'
      : '';
